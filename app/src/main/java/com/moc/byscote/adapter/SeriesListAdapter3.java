...
public class SeriesListAdapter3 extends RecyclerView.Adapter<SeriesListAdapter3.PersonViewHolder> {
    ...
    public SeriesListAdapter3(Context context , List<SeriesList> seriesList_Items) {
