...
public class SeriesListAdapter2 extends RecyclerView.Adapter<SeriesListAdapter2.PersonViewHolder> {
    ...
    public SeriesListAdapter2(Context context , List<SeriesList> seriesList_Items) {
    ...
    public void onBindViewHolder(final PersonViewHolder personViewHolder, final int i) {
      ...
      //  personViewHolder.tv_category.setBackgroundResource(categoryList_Items.get(i).getImg_src());
        if(i==0){
            Picasso.get().load(R.mipmap.a5).into(personViewHolder.img_series);
            personViewHolder.tv_series_title.setText("Patriot");
        }else if(i==1){
            Picasso.get().load(R.mipmap.a6).into(personViewHolder.img_series);
            personViewHolder.tv_series_title.setText("MINE");
        }else  if(i==2){
            Picasso.get().load(R.mipmap.a7).into(personViewHolder.img_series);
