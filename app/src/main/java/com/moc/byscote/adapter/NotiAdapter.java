...
public class NotiAdapter extends RecyclerView.Adapter<NotiAdapter.PersonViewHolder> {
    ...
    public NotiAdapter(Context context , List<SeriesList> seriesList_Items) {
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.noti_list_item, viewGroup, false);
    ...
    public void onBindViewHolder(final PersonViewHolder personViewHolder, final int i) {
        ...
        personViewHolder.tv_noti_title.setText(seriesList_Items.get(i).getSeries_name());
      //  personViewHolder.tv_category.setBackgroundResource(categoryList_Items.get(i).getImg_src());
        if(i==0){
            ...
            personViewHolder.tv_noti_title.setText("GERONIMO");
        }else if(i==1){
            Picasso.get().load(R.mipmap.slider1).into(personViewHolder.img_series);
            personViewHolder.tv_noti_title.setText("Blade Runner 2049");
        }else  if(i==2){
            Picasso.get().load(R.mipmap.a11).into(personViewHolder.img_series);
            personViewHolder.tv_noti_title.setText("First Look");
        }else {
            Picasso.get().load(R.mipmap.a12).into(personViewHolder.img_series);
            personViewHolder.tv_noti_title.setText(seriesList_Items.get(i).getSeries_name());
        }
    ...
    public static class PersonViewHolder extends RecyclerView.ViewHolder {
        ...
        PersonViewHolder(View itemView) {
            ...
            tv_noti_title = itemView.findViewById(R.id.tv_noti_title);
