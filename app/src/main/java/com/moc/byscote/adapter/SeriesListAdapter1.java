...
public class SeriesListAdapter1 extends RecyclerView.Adapter<SeriesListAdapter1.PersonViewHolder> {
    ...
    public SeriesListAdapter1(Context context , List<SeriesList> seriesList_Items) {
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.series_list_item1, viewGroup, false);
