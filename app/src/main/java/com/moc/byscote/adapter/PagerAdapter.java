...
public class PagerAdapter extends RecyclerView.Adapter<PagerAdapter.PersonViewHolder> {
    ...
    public PagerAdapter(Context context , List<SeriesList> seriesList_Items) {
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.pager_list_item, viewGroup, false);
    ...
    public void onBindViewHolder(final PersonViewHolder personViewHolder, final int i) {
      ...
      //  personViewHolder.tv_category.setBackgroundResource(categoryList_Items.get(i).getImg_src());
        if(i==0){
            ...
            personViewHolder.tv_series_title.setText("Blade Runner 2049");
        }else  if(i==2){
